...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $status = $request->input('status'); // Fetch the status filter from the request
        ...
        // Query orders within the date range and optional status filter
        ...
        return view('admin.dashboard', compact('totalOrders', 'totalRevenue', 'totalBaseRevenue', 'totalCustomers', 'recentOrders', 'chartData', 'dateFrom', 'dateTo', 'status'));
    }
